...
<head>
    ...
    <title>Modulo 2 - Modificar Listas de precios</title>
    ...
    <div class="main">
        <div class="cantainer__I">
            ...
            <div class="contaainer__description">
                <div class="contaainer__description__title">
                    <h1>2.2 MODIFICAR LISTAS DE PRECIOS</h1>
                </div>
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>2.2.2 Formación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="ModificarlistasdepreciosFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'modificarlistasdeprecios', "apartado":'formacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3ModificarlistasdepreciosEvaluacion.php";
        else 
