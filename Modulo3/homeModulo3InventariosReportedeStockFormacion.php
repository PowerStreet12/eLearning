    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="container__iframe">
                <center>
                    <iframe src="InventariosReportedeStockFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'manejodeinventarios', "apartado":'formacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3InventariosReportedeStockEvaluacion.php";
        else 
