                ...
                <div class="container__instructios">
                    ...
                    <div class="container__instructios__text">
                        <p>
                            ...
                            3.-Haz clic en el botón <span>Ajustes de inventario</span>.
                        </p>
                    </div>
                </div>
                <h1>2.5.3 Evaluación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="InventariosReportedeStockEvaluacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
            <div class="container__subtitle">
                <button id="demo">Ajustes de inventario</button>
            </div>
        </div>
    </div>
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'manejodeinventarios', "apartado":'evaluacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3InventariosAjusteseingresodemercaderia.php";
        else 
