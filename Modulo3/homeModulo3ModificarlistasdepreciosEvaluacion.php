    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="container__instructios">
                ...
                <h1>2.2.3 Evaluación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="ModificarlistasdepreciosEvaluacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'modificarlistasdeprecios', "apartado":'evaluacion', "numero":'modulo3'},
        function(respuesta){
