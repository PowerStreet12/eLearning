...
<head>
    ...
    <title>Modulo 2 - Listas de precios</title>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="container__iframe">
                <center>
                    <iframe src="ListasdepreciosFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'listasdeprecios', "apartado":'formacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3ListasdepreciosEvaluacion.php";
        else 
