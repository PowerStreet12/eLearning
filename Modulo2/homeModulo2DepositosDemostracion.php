    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>1.2.1 Demostración</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="DepositosDemostracion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'depositos', "apartado":'demostracion', "numero":'modulo2'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo2DepositosFormacion.php";
        else 
