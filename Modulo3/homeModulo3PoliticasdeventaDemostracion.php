    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>2.6.1 Demostración</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="PoliticasdeventaDemostracion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'politicasdeventa', "apartado":'demostracion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3PoliticasdeventaFormacion.php";
        else 
