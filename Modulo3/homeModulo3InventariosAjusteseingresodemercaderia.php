...
<head>
    ...
    <title>Modulo 2 - Inventarios</title>
    ...
    <div class="main">
        <div class="cantainer__I">
            ...
            <div class="contaainer__description">
                <div class="contaainer__description__title">
                    <h1>2.5 INGRESO DE MERCADERIA</h1>
                </div>
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>2.5.4 Demostración</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="InventariosAjusteseingresodemercaderia/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'manejodeinventarios', "apartado":'ajustemercaderia', "numero":'modulo3'},
        function(respuesta){
