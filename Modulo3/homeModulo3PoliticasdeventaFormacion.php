...
<head>
    ...
    <title>Modulo 2 - Politicas de venta</title>
        ...
        <div class="cantainer__I">
            ...
            <div class="contaainer__description">
                <div class="contaainer__description__title">
                    <h1>2.6 POLITICAS DE VENTA</h1>
                </div>
                <div class="contaainer__description__text">
                    <p>
                        A continuación, aprenderás por medio de una demostración<br>
                        del sistema de Power Street como crear una Política de Venta.<br>
                        Al terminar podrás poner en practica <br>
                        los conocimientos adquiridos en esta sección.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="container__instructios">
                    ...
                    <div class="container__instructios__text">
                        <p>
                            ...
                            3.-Haz clic en el botón <span>Evaluación</span>.
                        </p>
                    </div>
                </div>
                <h1>2.6.2 Formación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="PoliticasdeventaFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
            <div class="container__subtitle">
                <button id="demo">Evaluación</button>
            </div>
        </div>
    </div>
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'politicasdeventa', "apartado":'formacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3PoliticasdeventaEvaluacion.php";
        else 
