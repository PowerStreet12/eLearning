    ...
    <div class="main">
        <div class="cantainer__I">
            ...
            <div class="contaainer__description">
                <div class="contaainer__description__title">
                    <h1>2.4 LIBROS DE RUTA</h1>
                </div>
                <div class="contaainer__description__text">
                    <p>
                        Lograr un buen manejo de la información de clientes, <br>
                        así como proporcionar diferentes opciones de<br>
                        asignación de los mismos de la manera que sea más sencilla <br>
        ...
        <div class="container">
            ...
            <div class="container__instructios">
                ...
                <h1>2.4.2 Formación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="LibrosderutaFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'librosderuta', "apartado":'formacion', "numero":'modulo3'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo3LibrosderutaEvaluacion.php";
        else 
