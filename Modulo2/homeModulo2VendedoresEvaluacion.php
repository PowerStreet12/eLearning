    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>1.3.3 Evaluación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="VendedoresEvaluacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'vendedores', "apartado":'evaluacion', "numero":'modulo2'},
        function(respuesta){
