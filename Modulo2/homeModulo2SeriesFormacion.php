...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>1.1.2 Formación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="SeriesFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
    ...
    <!-- <center>
        <br>
        <h1>Modulo 2 - Series formacion</h1>
        <br>
        <iframe src="SeriesFormacion/index.html" width=1090 height=660></iframe>
    </center> -->
</body>
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'series', "apartado":'formacion', "numero":'modulo2'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo2SeriesEvaluacion.php";
        else 
