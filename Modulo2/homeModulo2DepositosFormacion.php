...
<head>
    ...
    <title>Modulo 1 - Depositos</title>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="container__iframe">
                <center>
                    <iframe src="DepositosFormacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'depositos', "apartado":'formacion', "numero":'modulo2'},
        function(respuesta){
	    console.log(respuesta)
        if(respuesta == 1)
            window.location.href = "./homeModulo2DepositosEvaluacion.php";
        else 
