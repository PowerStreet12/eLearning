    ...
    <div class="main">
        ...
        <div class="container">
            <div class="container__title">
                ...
                <h1>2.6.3 Evaluación</h1>
            </div>
            <div class="container__iframe">
                <center>
                    <iframe src="PoliticasdeventaEvaluacion/index.html" style=""></iframe>
                </center>
            </div>
        </div>
        <div class="container">
...
function myFunction() {
    console.log("Clic");
    $.post("../validaciones/existe.php",{"modulo":'politicasdeventa', "apartado":'evaluacion', "numero":'modulo3'},
        function(respuesta){
